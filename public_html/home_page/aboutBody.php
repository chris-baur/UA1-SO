...
<html>
    ...
    <body>
            ...
            <!-- 
            <img src="../img/Wissem.jpg" alt="Wissem Bahloul" width="200" height="200" />

            <header>
          		<h1>Wissem Bahloul</h1>
              	<h2>Concordia Student</h2>
            </header>

            <p class="description">I am a student at Concordia and currently trying to make an about us page for a project in SOEN341 class.</p>
